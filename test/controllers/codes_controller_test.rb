...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { short_description: @code.short_description, url: @code.url } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { short_description: @code.short_description, url: @code.url } }
